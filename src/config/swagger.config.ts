          ...
          user: {
            ...
            properties: {
              ...
              profileCompleted: {
                type: 'boolean',
                example: false,
                description: 'Whether user has completed additional profile information',
              },
            },
          },
          tokens: {
  ...
  paths: {
    ...
    '/auth/login': {
      post: {
        ...
        description: 'Authenticate user with Firebase token and receive access & refresh tokens',
        requestBody: {
          required: true,
          content: {
            'application/json': {
...
- User can access full application features
    ...
    '/sos/citizen/cases': {
      get: {
        ...
        description: 'Retrieve all SOS cases created by the authenticated citizen',
        security: [
          {
            BearerAuth: [],
          },
    ...
    '/sos/admin/cases': {
      get: {
        ...
        description: 'Retrieve all SOS cases with filtering options (Admin only)',
        security: [
          {
            BearerAuth: [],
          },
    ...
    '/officer/admin/officers/active-locations': {
      get: {
        ...
        description: 'Retrieve real-time locations of on-duty officers (Admin only)',
        security: [
          {
            BearerAuth: [],
          },
